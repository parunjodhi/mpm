...
Let's say climate activists in the Honduras are arguing the disproportionate consequences that Honduras faced due to natural disasters (arguably exacerbated by climate change) as compared to the United States who emits way more GHG emissions.
...
The climate activists can therefore use some of the tools above to prove their argument.
...
From the table generated above, we can look at the trends of each variable before, in and after 2008 and make inferences how did the Great Recessions affected these metrics in Mexico.
...
In 2040, holding all else constant, Canada is estimated to release 1094 million tonnes of GHG emissions. This is still below our fictional threshold level. However, referring the warning given in the output, this prediction is based off of a linear model and not off of an exponential one which is more likely.
